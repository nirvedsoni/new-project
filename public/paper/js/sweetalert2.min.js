!(function (e, t) {
    ...
    var e = {
        ...
        U = function (e) {
            ...
            for (var a in e)
                $.isValidParameter(a) ||
                    console.warn('SweetAlert2: Unknown parameter "' + a + '"');
            (t.style.width =
            ...
            if (
                (e.titleText
                    ? (p.innerText = e.titleText)
                    : (p.innerHTML = e.title.split("\n").join("<br />")),
                e.text || e.html)
            ) {
                if ("object" === I(e.html))
                    ...
                    e.html
                        ? (y.innerHTML = e.html)
                        : e.text && (y.textContent = e.text);
                P(y);
            } else L(y);
            e.showCloseButton ? P(B) : L(B),
                (t.className = n.modal),
                e.customClass && E(t, e.customClass);
            var V = h(),
                O = parseInt(
            ...
            if (e.type) {
                ...
                if ((P(K), e.animation))
                    switch (e.type) {
                        case "success":
                            E(K, "swal2-animate-success-icon"),
                                E(
                                    K.querySelector(".swal2-success-line-tip"),
                                    "swal2-animate-success-line-tip"
                                ),
                                E(
                                    K.querySelector(".swal2-success-line-long"),
                                    "swal2-animate-success-line-long"
                                );
                            break;
                        case "error":
                            E(K, "swal2-animate-error-icon"),
                                E(
                                    K.querySelector(".swal2-x-mark"),
            ...
            var D = v();
            e.imageUrl
                ? (D.setAttribute("src", e.imageUrl),
                  P(D),
                  e.imageWidth
                      ? D.setAttribute("width", e.imageWidth)
                      : D.removeAttribute("width"),
                  e.imageHeight
                      ? D.setAttribute("height", e.imageHeight)
                      : D.removeAttribute("height"),
                  (D.className = n.image),
                  e.imageClass && E(D, e.imageClass))
                : L(D),
                e.showCancelButton ? (S.style.display = "inline-block") : L(S),
                e.showConfirmButton ? M(x, "display") : L(x),
                e.showConfirmButton || e.showCancelButton ? P(k) : L(k),
                (x.innerHTML = e.confirmButtonText),
                (S.innerHTML = e.cancelButtonText),
                e.buttonsStyling &&
                    ((x.style.backgroundColor = e.confirmButtonColor),
                    (S.style.backgroundColor = e.cancelButtonColor)),
                (x.className = n.confirm),
                E(x, e.confirmButtonClass),
                (S.className = n.cancel),
                E(S, e.cancelButtonClass),
                e.buttonsStyling
                    ? (E(x, n.styled), E(S, n.styled))
                    : (A(x, n.styled),
                      A(S, n.styled),
                      ...
                      (S.style.backgroundColor =
                          ...
                          S.style.borderRightColor =
                              "")),
                !0 === e.animation ? A(t, n.noanimation) : E(t, n.noanimation),
        ...
        z = function (e, t) {
            var o = u(),
                r = c();
            e ? (E(r, n.show), E(o, n.fade), A(r, n.hide)) : A(r, n.fade),
                P(r),
        ...
        $ = function e() {
            ...
            return new Promise(function (t, o) {
                ...
                (window.onkeydown &&
                    window.onkeydown.toString() === D.toString()) ||
                ...
                switch (l.input) {
                    ...
                    case "tel":
                    case "url":
                        ((Q = B(d, n.input)).value = l.inputValue),
                            (Q.placeholder = l.inputPlaceholder),
                            (Q.type = l.input),
                            P(Q);
                        break;
                    case "file":
                        ((Q = B(d, n.file)).placeholder = l.inputPlaceholder),
                            (Q.type = l.input),
                            P(Q);
                        break;
                    case "range":
                ...
                ("select" !== l.input && "radio" !== l.input) ||
                    ...
                    "undefined" == typeof MutationObserver ||
                        W ||
                        (W = new MutationObserver(e.recalculateHeight)).observe(
                            d,
